...
<div className="w-full mt-[50px]  px-3  md:px-[100px] border-t  border-t-[var(--softBg5)] rounded-lg md:rounded-[20px] flex flex-col md:flex-row gap-6">
  {/* Left: Map - 2/3 Width */}
 

  {/* Right: Contact Info - 1/3 Width */}
  <div className="md:w-1/2 flex flex-col justify-between gap-6" data-aos="fade-left" data-aos-delay="200">
    {/* Address Box */}
  ...
  <div className="md:w-1/2 rounded-lg overflow-hidden" data-aos="fade-right" data-aos-delay="100">
    <iframe
